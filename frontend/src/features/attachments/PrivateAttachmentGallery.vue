...
<template>
  <div
    ...
    class="private-attachment-gallery"
    :class="`align-${align}`"
    aria-label="消息图片"
  >
...
<style scoped>
.private-attachment-gallery { display: flex; flex-wrap: wrap; justify-content: flex-start; gap: 8px; margin-bottom: 8px; }
.private-attachment-gallery.align-end { justify-content: flex-end; }
.private-attachment-gallery figure { width: min(112px, 30vw); margin: 0; text-align: left; }
.private-attachment-gallery.align-end figure { text-align: right; }
