...
.draft-image { position: relative; width: 92px; flex: 0 0 92px; margin: 0; }
.draft-image img { width: 92px; height: 68px; display: block; object-fit: cover; border: 1px solid rgba(92,108,158,.16); border-radius: 12px; background: #eef1f5; }
