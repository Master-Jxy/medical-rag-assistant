...
class VisionObservationRecord(Base):
    ...
    focus_instruction_hash: Mapped[str | None] = mapped_column(String(64))
    ...
    __table_args__ = (
        ...
        UniqueConstraint("media_asset_id", "run_id", "assistant_message_id", "kind", "focus_instruction_hash", name="uq_vision_observations_idempotency"),
