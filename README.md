...
一个面向医学资料学习与内部知识检索场景的前后端分离 RAG 应用。系统支持 PDF/TXT/DOCX/Markdown/HTML 文档管理、向量检索、流式问答、引用来源、多轮会话和刷新恢复。
...
- FastAPI + Vue 3 前后端分离。
- PDF/TXT/DOCX/Markdown/HTML 上传、解析、递归切分和 SHA-256 内容去重。
...
- **公共知识库**：提交 PDF/TXT/DOCX/Markdown/HTML、查看已发布资料；提交成功不等于已发布。
